...
Indexer:
Environment: BENCHMARK_ENABLED=true;BENCHMARK_FINISHED_WORKERS_TARGET=1;BENCHMARK_TARGET_BLOCK_ID=25005000;DB_CH_URL=clickhouse://user:pass@localhost:9000/ton?sslmode=disable;DB_PG_URL=postgres://user:pass@localhost:5432/ton?sslmode=disable;DEBUG_LOGS=true;DYLD_LIBRARY_PATH=/usr/local/lib:$$DYLD_LIBRARY_PATH;FROM_BLOCK=25000000;LITESERVERS=135.181.177.59:53312|aF91CuUHuuOv9rm2W5+O/4h38M3sRm40DtSdRxQhmtQ=;RESCAN_SELECT_LIMIT=1000;RESCAN_WORKERS=4;WORKERS=1
```
