...
func (s *Service) Start() error {
	...
	s.mx.Lock()
	// TODO: здесь начинается считывание с блокчейна. Тут будем параллелить работу по считыванию блоков
	// TODO: посмотреть какое эффективное количество блоков должно быть на каждом поде
	s.run = true
	s.mx.Unlock()
